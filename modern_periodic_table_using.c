...
int main()
{
    ...
    if (n == 1)
    {
        ...
        if (m == 3)
        {
            ...
            if (a == 1)
            {
                ...
                printf("Eletronic Configuration : 1s^1\n");
    ...
    else if (n == 2)
    {
        ...
        if (Exit == 6)
        {
            printf("Are you sure you want to class the periodic table ? (Yes/No)\n");
            ...
            {
                printf("Periodic table has not closed and you can continue to learn more about element\n\n");

                printf("Enter the atomic numbe od the element to be searched : \n\n");
                scanf("%d", &a);
        ...
        {
            printf("Periodic table has no closed and uou can continue to learn more element\n\n");
